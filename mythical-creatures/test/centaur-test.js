...
describe('Centaur', function() {
 ...
 // console.log(centaur.cranky);
    assert.equal(centaur.cranky, false);
    //shootBow 3 times returns cranky.true;
    // or run 3 times returns cranky.true
    centaur.shootBow()
    centaur.run()
    centaur.shootBow()
// console.log(centaur.cranky);
  ...
  it('should be cranky after running or shooting a bow three times', function() { //OR shooting a bow
    var centaur = new Centaur({ name: 'Georgiana', type: 'Palomino' });
// console.log(centaur.cranky);
    assert.equal(centaur.cranky, false);
