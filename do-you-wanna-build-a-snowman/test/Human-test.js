...
describe("Human", function () {
  ...
  it('should be able to gather materials', function() {
    ...
    human.gatherMaterials('carrots', 1);//these are in '' so need []
  ...
  it('should be able to use gathered materials to build a snowman', function() {
    ...
    assert.instanceOf(snowman, Snowman);//instanceOf
  ...
  // console.log('test 82 -', human.placeMagicHat());
  ...
  // console.log('test 100 -', human.placeMagicHat());
